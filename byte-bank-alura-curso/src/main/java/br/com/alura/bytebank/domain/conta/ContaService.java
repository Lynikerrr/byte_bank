...
public class ContaService {
    ...
    public Set<Conta> listarContasAbertas() {
        Connection conn = connection.recuperarConection();
    ...
    public void realizarSaque(Integer numeroDaConta, BigDecimal valor) {
        ...
        if (!conta.getEstaAtiva()){
            throw new RegraDeNegocioException("Essa conta não está ativa!!");
        }
    ...
    private Conta buscarContaPorNumero(Integer numero) {
        ...
        if(conta != null){
            ...
            throw new RegraDeNegocioException("Não existe uma conta cadastrada com esse numero!");
        }
    }
